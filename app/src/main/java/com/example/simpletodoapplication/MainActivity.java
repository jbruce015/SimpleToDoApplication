package com.example.simpletodoapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(v -> {
            ...
            // Add to the model
            items.add(todoItem);
            //Notify adapter that an item is inserted and place it last
    ...
    // This function saves items by writing them the data file
